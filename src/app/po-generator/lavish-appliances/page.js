...
const LAVISH_CONFIG = {
  key: "lavish-appliances",
  name: "Lavish Appliances",
  address: "9-Sorathiyawadi, aaradhna chowk, rajkot -360002",
  price: "F.O.R RAJKOT",
};

export default function LavishAppliancesPO() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#f8f8f8' }}>
      <main style={{ background: '#fff', padding: '2rem 3rem', borderRadius: 16, boxShadow: '0 2px 16px rgba(0,0,0,0.07)', minWidth: 350 }}>
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: 8 }}>PO Generator - Lavish Appliances</h1>
        <p style={{ color: '#666', marginBottom: 24 }}>Fill in the details below to generate your Purchase Order.</p>
        {!formData ? (
          <POForm withConsignee={true} supplierConfig={LAVISH_CONFIG} onSubmit={setFormData} />
        ) : (
