...
const PALMLINE_CONFIG = {
  key: "palmline-plastics",
  name: "Palmline Plastics Pvt. Ltd",
  address: "A/16, Tirupathi Udhyog Nagar, Sativali Road, Vasai - E(Dist. Theme) - 401208\nMaharastra, India",
  price: "F.O.R MUMBAI",
};

export default function PalmlinePlasticsPO() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#f8f8f8' }}>
      <main style={{ background: '#fff', padding: '2rem 3rem', borderRadius: 16, boxShadow: '0 2px 16px rgba(0,0,0,0.07)', minWidth: 350 }}>
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: 8 }}>PO Generator - Palmline Plastics</h1>
        <p style={{ color: '#666', marginBottom: 24 }}>Fill in the details below to generate your Purchase Order.</p>
        {!formData ? (
          <POForm withConsignee={true} supplierConfig={PALMLINE_CONFIG} onSubmit={setFormData} />
        ) : (
